"""Instrumented asynchronous HTTP client for warehouse catalogue reads."""
...
from warehouse.models import CatalogueResponse
...
class WarehouseClient:
    """V1 warehouse client exposing catalogue reads only."""
